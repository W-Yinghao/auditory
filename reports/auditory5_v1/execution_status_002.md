...
生成时间：2026-09-17T04:45:27.835844+00:00。这是运行记录，不是五路线最终结论。
...
表示任务完成 72/90，其中计划60个学习型编码器、30个L0/随机编码器任务。并发上限2 GPU/4 CPU作业；大数组受Slurm提交限额限制，改为固定worker顺序执行。
...
- C：FAIL，详见 results/auditory5_v1/C_L0_003/summary.json。
- E：尚无完成的读出汇总，不能记为阴性或阳性。

## 已完成的监督/随机表征核心结果

- A R_SUP：主条件对比T=0.0418，95%区间[-0.0016369159412120552, 0.08896226931281295]；背景重复T=0.4569。尚不替代其余预设对照。
- A R_RAND：主条件对比T=0.0232，95%区间[-0.012213894212043842, 0.062219019786931444]；背景重复T=0.4048。尚不替代其余预设对照。
- B R_SUP：60人，主增益-0.00134 bits/trial，95%区间[-0.00228, -0.00041]。
- B R_RAND：60人，主增益-0.00152 bits/trial，95%区间[-0.00255, -0.00046]。
- D R_SUP：51人，C+visible和C+visible+null的MAE均为6.418；null增益0.000，区间[0.000, 0.000]。
...
聚合表：results/auditory5_v1/execution_status_002/stimulus_decoding.csv；任务状态：results/auditory5_v1/execution_status_002/task_status.csv。
