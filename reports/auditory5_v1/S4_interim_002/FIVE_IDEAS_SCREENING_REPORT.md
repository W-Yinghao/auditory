...
执行状态：**IN_PROGRESS**；表征状态：**IN_PROGRESS**（80/90）。
...
| B | calibrated_main_gain | NEED_CONTROLS | PENDING | SEE_EFFECT_AND_CONTROLS | False |
| C | T_C_mlp32_calibrated | IMPLEMENTATION_FAIL | FAIL | SEE_EFFECT_AND_CONTROLS | False |
| D | D2_minus_D3 | NEED_CONTROLS | PENDING | SEE_EFFECT_AND_CONTROLS | False |
