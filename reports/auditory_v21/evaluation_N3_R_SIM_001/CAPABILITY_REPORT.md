...
N3_R_SIM: **PASS**. Fixed seeds and thresholds; no participant outcomes fitted.

| World | Rate | Evaluable | Recoveries | Meaningful FP | Raw FP | Risk preserved | Status |
|---|---:|---:|---:|---:|---:|---:|---|
| strong_history_null | 0.15 | 20/20 | 0 | 0 | 0 | 19 | PASS |
...
| strong_history_increment_weak | 0.15 | 20/20 | 0 | 0 | 2 | 20 | DESCRIPTIVE_ONLY |
| strong_history_increment_weak | 0.2 | 20/20 | 0 | 1 | 3 | 20 | DESCRIPTIVE_ONLY |
